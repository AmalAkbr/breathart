export const verificationEmailTemplate = ({ verificationUrl }: { verificationUrl: string }) => {
...
export const passwordResetEmailTemplate = ({ resetUrl, resetToken }: { resetUrl: string; resetToken?: string }) => {
...
export const examInvitationEmailTemplate = ({ studentName, examDetails }: { studentName: string, examDetails: any }) => {
  const {
    title,
    googleFormLink,
    description,
