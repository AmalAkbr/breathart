...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen w-full max-w-[100vw] flex flex-col bg-bg-dark text-white font-sans selection:bg-accent-cyan/30 overflow-x-hidden">
      ...
      <header
        className={`fixed top-0 w-full z-[70] transition-all duration-300 py-1 md:py-2 px-4 md:px-8 lg:px-12 flex justify-between items-center ${
          isWhiteNav
      ...
      >
        <div className="flex items-center gap-2 md:gap-3 transition-colors duration-300">
          <Logo
            variant={isWhiteNav ? "dark" : "light"}
            className="w-14 h-14 md:w-16 md:h-16 text-current scale-[1.5] origin-left"
          />
          <div className="flex flex-col justify-center">
            <h1 className="text-base md:text-xl font-heading font-bold text-gradient leading-tight">
              BreathArt Institute
            </h1>
            <span
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <div className="hidden sm:flex items-center gap-3.5 mr-2">
            <a
              ...
              className="w-[30px] h-[30px] rounded-[8px] flex items-center justify-center hover:scale-105 hover:shadow-lg transition-all cursor-pointer overflow-hidden shadow-sm"
            >
              <img
                src={insta}
                alt="Instagram"
            ...
            >
              <img
                ...
                loading="lazy"
                decoding="async"
                className="w-full h-full object-cover scale-[1.3] transform translate-y-[1px]"
              />
            </a>
          </div>
          <button
            onClick={() => setContactOpen(true)}
            className={`hidden sm:flex items-center gap-2 text-xs md:text-sm font-bold transition-all border rounded-full px-4 py-2 shadow-sm whitespace-nowrap ${
              isWhiteNav
          ...
          <Link
            to="/"
            className={`flex items-center gap-2 text-xs md:text-sm font-bold transition-all border rounded-full px-4 py-2 shadow-sm whitespace-nowrap ${
              isWhiteNav
      ...
      >
        ...
        <div className="w-full px-4 md:px-12 grid lg:grid-cols-2 gap-8 md:gap-12 items-center z-10">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            >
              ...
              Digital Marketing &<br className="hidden sm:block" /> Creative
              Training Institute
            </motion.h1>
          </div>
        ...
        >
          <span className="text-[10px] md:text-xs font-medium text-slate-400 uppercase tracking-[0.2em] hidden sm:block">
            Scroll to explore
          </span>
      ...
      <Suspense fallback={<SectionLoader />}>
        ...
        <section className="relative z-20 px-4 md:px-8 lg:px-12 py-20 md:py-32 w-full bg-white text-center flex flex-col items-center justify-center theme-light-section overflow-hidden">
          ...
          >
            <motion.div
              variants={fadeInUp}
              className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-blue-200 bg-blue-50 text-slate-700 font-bold text-xs md:text-sm mb-6 md:mb-8 shadow-sm mx-auto"
            >
              <Zap className="w-3.5 h-3.5 md:w-4 md:h-4 text-accent-blue cursor-pointer" />{" "}
              <span>Transform Your Career in 2026</span>
            </motion.div>

            <motion.h2
              variants={fadeInUp}
              className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight mb-6 md:mb-8 leading-[1.1] text-slate-900 font-heading flex flex-col items-center"
            >
            ...
            <motion.p
              variants={fadeInUp}
              className="text-base sm:text-lg md:text-xl text-slate-700 leading-relaxed mb-4 max-w-2xl mx-auto px-4 sm:px-0 font-medium"
            >
              Join the best digital marketing academy in Attingal. Learn SEO,
              Google Ads & social media marketing with expert trainers. Enroll
              today!
            </motion.p>
            <motion.p
              variants={fadeInUp}
              className="text-base sm:text-lg text-slate-500 leading-relaxed mb-8 md:mb-12 max-w-2xl mx-auto px-4 sm:px-0"
            >
              Learn the art of digital marketing where artificial intelligence
              meets UAE-specific expertise. Our institute prepares you with
              industry-ready skills for today's competitive market.
            </motion.p>

            <motion.div
              variants={fadeInUp}
              className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center px-4 sm:px-0 w-full sm:w-auto"
            >
              <Link
                to="/admission"
                className="w-full sm:w-auto px-6 md:px-8 py-3.5 md:py-4 rounded-full bg-gradient-to-r from-accent-blue to-blue-600 text-white font-bold text-base md:text-lg hover:shadow-xl hover:shadow-accent-blue/25 hover:-translate-y-1 transition-all flex justify-center items-center"
              >
                Enroll Now
              </Link>
            </motion.div>
          ...
          <div className="max-w-[1200px] mx-auto">
            ...
            >
              <div className="text-center w-full md:w-1/3 py-2 md:py-0 px-4">
                ...
                <p className="text-xs md:text-sm text-accent-cyan font-bold uppercase tracking-wider mt-2">
                  Practical Training
                </p>
              </div>
              ...
              <div className="text-center w-full md:w-1/3 pt-6 pb-2 md:py-0 px-4">
                <p className="text-4xl md:text-5xl font-extrabold text-white">
                  <CountUp from={0} to={24} duration={1.5} />
                  /7
                </p>
                <p className="text-xs md:text-sm text-accent-cyan font-bold uppercase tracking-wider mt-2">
                  Student Mentorship
        ...
        <section className="relative z-20 px-4 md:px-8 lg:px-12 py-16 md:py-24 w-full bg-white theme-light-section">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <Aurora
                colorStops={["#000000", "#06b6d4", "#ffffff"]}
                amplitude={1.2}
              />
                  ...
                  <div className="flex flex-col justify-center text-left flex-1">
                    ...
                    <div className="space-y-4 md:space-y-6 text-slate-200 text-sm sm:text-base md:text-lg leading-relaxed">
                      <p>
                        ...
                        is a UAE-based creative and business group offering a
                        complete ecosystem of AI-powered digital marketing,
                        branding solutions, education institutes, professional
                        photography studios, and business consultancy services.
                      </p>
                      <p>
                        Founded in 2024 in the United Arab Emirates, BreathArt
                        Group has expanded its operations to India and global
                        markets, supporting brands and individuals across
                        multiple industries. Our integrated approach helps
                        businesses achieve strong online visibility,
                        high-quality lead generation, and long-term brand
                        growth.
                      </p>
                      <p>
                        With a growing international presence, we have
                        successfully served more than{" "}
                        <strong className="text-white">
                          500 happy clients worldwide
                        </strong>
                        , delivering measurable results and creating new
                        business opportunities every month across the globe.
                      </p>
                      <p className="text-lg md:text-xl text-white font-medium mt-6 md:mt-8 pt-6 md:pt-8 border-t border-white/20">
                        At BreathArt Group, we focus on transforming companies
                        into brands by combining strategic marketing, creative
                        innovation, advanced AI solutions, and industry-focused
                        education.
                      </p>
                    </div>
                  </div>
        ...
        <section className="py-16 md:py-24 relative overflow-hidden text-white">
          ...
          <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none overflow-hidden">
            <img
              ...
              loading="lazy"
              decoding="async"
              className="w-[80%] max-w-[800px] h-auto object-contain opacity-30 scale-[1.2]"
            />
          ...
          <div className="max-w-6xl mx-auto px-4 md:px-8 lg:px-12 relative z-10 text-center">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-6">
                Trusted By <span className="text-accent-cyan">500+</span> Global
                Clients
              </h2>
              <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed mb-12 px-4 sm:px-0 font-medium">
                Our agency wing has delivered successful campaigns, branding,
                and development for over 500 businesses worldwide. As a student,
                you'll learn the exact strategies we use for our paying clients.
              </p>
        ...
        <section
          id="contact"
          className="py-12 md:py-16 px-4 md:px-8 lg:px-12 bg-white relative z-10 border-b border-slate-200 theme-light-section"
        >
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16 items-stretch">
            ...
            >
              <span className="text-accent-cyan font-bold tracking-widest uppercase text-xs md:text-sm mb-3 block text-center lg:text-left">
                Enrollment
              </span>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 text-slate-900 leading-tight text-center lg:text-left">
                Start Your <br className="hidden md:block" />
                Journey Today
              </h2>
              <p className="text-slate-600 text-base md:text-lg mb-8 md:mb-10 text-center lg:text-left">
                Admissions are open for the upcoming batch. Get in touch with
                our counselors to find the right program for you.
              </p>

              <div className="space-y-4 md:space-y-6">
                <a
                  href="tel:+918590144794"
                  className="flex items-center gap-4 group p-4 md:p-5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-accent-blue hover:shadow-xl hover:shadow-accent-blue/10 transition-all w-full"
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-xs md:text-sm text-slate-500 mb-0.5 font-medium uppercase tracking-wider">
                      Call Us Now
                    </p>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-4 group p-4 md:p-5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-accent-cyan hover:shadow-xl hover:shadow-accent-cyan/10 transition-all w-full"
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-base md:text-lg font-bold text-slate-900 truncate block">
