        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            ...
            <p className="text-slate-600 mb-10 text-lg leading-relaxed">
              Have questions about our programs, admissions, or how AI-powered
              marketing can boost your career? Our team is here to guide you
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-slate-600 hover:text-accent-blue transition-colors font-medium"
                  >
                    +91 8590 144 794
                  </a>
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 leading-relaxed font-medium">
                    Breathart Institute of Creative Technology (BICT)
                    <br />
                    Karthika Tower, Opposite Wedland Weddings,
                    <br />
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="Diploma in Photography">
                    ...
                    <option value="Integrated Diploma in Creative Media">
