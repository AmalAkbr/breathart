...
const Footer = ({ isLanding = false }) => {
  return (
    <footer
      id="contact"
      className="py-12 border-t border-black/40 bg-black text-white shadow-[0_-4px_30px_rgba(0,0,0,0.5)]"
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10 md:mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-400 mb-6 max-w-sm">
              Shaping future leaders through AI-powered creative education and
            ...
            <div className="flex gap-4 mb-8">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-accent-cyan/20 hover:border-accent-cyan/40 transition-colors cursor-pointer overflow-hidden"
              >
                <img
                  src={insta}
                  alt="Instagram"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-accent-blue/20 hover:border-accent-blue/40 transition-colors cursor-pointer overflow-hidden p-[2px]"
              >
                <img
                  src={face}
                  alt="Facebook"
                  loading="lazy"
                  decoding="async"
                  className="w-full h-full object-cover rounded-[10px] scale-110"
                />
              </a>
              <a
