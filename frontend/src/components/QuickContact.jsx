      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center justify-between bg-white/60 backdrop-blur-xl border border-slate-200 rounded-3xl p-8 md:p-12 shadow-2xl">
          ...
          <div className="flex-1 text-center lg:text-left flex flex-col justify-center">
            ...
            >
              Speak directly with our expert career counselors. We'll help you
              find the perfect training path mapped exactly to market demands.
            </motion.p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-slate-900 font-bold text-sm lg:text-base leading-none">
                    +91 8590 144 794
                  </p>
                </div>
              </motion.a>
            ...
            >
              <span className="text-xs text-slate-500 font-bold uppercase tracking-widest mr-2">
                Connect:
              </span>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center hover:scale-110 transition-all group overflow-hidden drop-shadow-md"
              >
                <svg
                  className="w-6 h-6 text-slate-500 group-hover:text-green-500 transition-colors z-10"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center hover:scale-110 transition-all overflow-hidden drop-shadow-md"
              >
                <img
                  src={insta}
                  alt="Instagram"
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Creative Education">
                      Creative Education
                    </option>
                    <option value="Master Diploma in AI Digital Marketing">
                      Master Diploma in AI Digital Marketing
                    </option>
                    <option value="Diploma in AI Digital Marketing">
                      Diploma in AI Digital Marketing
                    </option>
                    <option value="Diploma in Graphic Design & Photography">
                      Diploma in Graphic Design & Photography
                    </option>
              ...
              <button
                ...
                className={`w-full mt-2 group relative flex items-center justify-center gap-2 px-6 py-3.5 text-white font-bold text-sm rounded-xl overflow-hidden transition-all duration-300 ${
