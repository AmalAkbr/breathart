            ...
            <div className="bg-bg-dark border border-white/10 w-full max-w-2xl rounded-2xl shadow-2xl shadow-accent-cyan/10 overflow-hidden pointer-events-auto flex flex-col max-h-[90vh]">
              ...
              <div className="p-6 md:p-8 border-b border-white/10 shrink-0 relative bg-bg-mid">
                ...
                <p className="text-slate-400 mt-2 text-sm md:text-base">
                  Fill out the form below to apply for this position. We'll get
                  back to you soon!
                </p>
              </div>
                ...
                {isSuccess ? (
                  ...
                  >
                    ...
                    <p className="text-slate-400 max-w-md">
                      Thank you for applying for the {jobTitle} position. Our
                      team will review your application and get in touch.
                    </p>
                  </motion.div>
                ) : (
                  <form
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        Please provide a link to your resume or portfolio
                        (Google Drive, Dropbox, Portfolio website, etc.)
                      </p>
                    </div>
