...
const Careers = () => {
    return (
        <div className="min-h-screen bg-bg-mid pt-32 pb-24 w-full max-w-[100vw] overflow-x-hidden">
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    {jobs.map((job, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-bg-mid border border-white/10 p-8 rounded-2xl hover:border-accent-blue/40 transition-colors shadow-2xl shadow-black/20 flex flex-col h-full"
                        >
                            <div className="flex-grow">
                                ...
                                <div className="mb-6">
                                    ...
                                    <p className="text-slate-300">{job.goal}</p>
                                </div>
