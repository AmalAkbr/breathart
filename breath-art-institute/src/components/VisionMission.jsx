...
const VisionMission = () => {
    return (
        <section className="py-24 lg:py-40 relative overflow-hidden bg-gradient-to-b from-secondary via-bg-dark to-secondary">
            ...
            <div className="w-full max-w-[1600px] mx-auto px-4 md:px-12 lg:px-16 relative z-10">
                <div className="text-center mb-10 lg:mb-14">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-black text-white tracking-tight drop-shadow-lg">
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
                    ...
                    <motion.div
                        ...
                        className="w-full h-full min-h-[160px] lg:min-h-[180px]"
                    >
                        <TiltedCard
                            imageSrc={cardBg}
                            containerHeight="100%"
                            ...
                            className="w-full h-full min-h-[160px] lg:min-h-[180px]"
                            overlayContent={
                                <div className="absolute inset-0 px-4 py-2 lg:px-6 lg:py-4 rounded-[2rem] bg-white/20 border border-white/50 overflow-hidden group hover:border-accent-cyan/70 hover:bg-white/30 transition-colors duration-700 shadow-xl shadow-black/10 flex flex-col justify-center backdrop-blur-md w-full h-full">
                                    ...
                                    <div className="relative z-10">
                                        <h3 className="text-2xl lg:text-4xl font-heading font-black text-black mb-1 lg:mb-2 tracking-tight drop-shadow-sm">
                                            <SplitText text="VISION" delay={80} duration={0.8} rootMargin="-50px" />
                                        </h3>
                                        <span className="inline-block text-sm lg:text-base text-blue-700 font-bold tracking-wide uppercase mb-2 lg:mb-3 pb-1 lg:pb-2 border-b border-blue-700/30">
                                            <SplitText text="Shaping Future Leaders" delay={30} splitType="chars" duration={0.8} />
                                        </span>
                                        <div className="text-sm lg:text-base text-slate-900 leading-snug lg:leading-relaxed font-medium">
                    ...
                    <motion.div
                        ...
                        className="w-full h-full min-h-[160px] lg:min-h-[180px] lg:translate-y-6"
                    >
                        <TiltedCard
                            imageSrc={cardBg}
                            containerHeight="100%"
                            ...
                            className="w-full h-full min-h-[160px] lg:min-h-[180px]"
                            overlayContent={
                                <div className="absolute inset-0 px-4 py-2 lg:px-6 lg:py-4 rounded-[2rem] bg-white/20 border border-white/50 overflow-hidden group hover:border-accent-blue/70 hover:bg-white/30 transition-colors duration-700 shadow-xl shadow-black/10 flex flex-col justify-center backdrop-blur-md w-full h-full">
