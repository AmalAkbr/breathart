        ...
        <section className="py-24 lg:py-40 relative overflow-hidden bg-gradient-to-b from-secondary via-bg-dark to-secondary">
            ...
            <div className="w-full max-w-[1600px] mx-auto px-4 md:px-12 lg:px-16 relative z-10">
                <div className="text-center mb-16 lg:mb-24">
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading font-black text-white tracking-tight drop-shadow-lg">
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
                    ...
                    >
                        <TiltedCard
                            ...
                            overlayContent={
                                <div className="absolute inset-0 p-8 lg:p-10 rounded-[2rem] bg-white/20 border border-white/50 overflow-hidden group hover:border-accent-cyan/70 hover:bg-white/30 transition-colors duration-700 shadow-xl shadow-black/10 flex flex-col justify-center backdrop-blur-md w-full h-full">
                                    ...
                                    <div className="relative z-10">
                                        <h3 className="text-3xl lg:text-5xl font-heading font-black text-black mb-2 tracking-tight drop-shadow-sm">
                                            <SplitText text="VISION" delay={80} duration={0.8} rootMargin="-50px" />
                                        </h3>
                                        <span className="inline-block text-base lg:text-lg text-blue-700 font-bold tracking-wide uppercase mb-4 pb-2 border-b border-blue-700/30">
                                            <SplitText text="Shaping Future Leaders" delay={30} splitType="chars" duration={0.8} />
                                        </span>
                                        <div className="text-base lg:text-lg text-slate-900 leading-relaxed font-medium">
                    ...
                    >
                        <TiltedCard
                            ...
                            className="w-full h-full min-h-[300px] lg:min-h-[350px]"
                            overlayContent={
                                <div className="absolute inset-0 p-8 lg:p-10 rounded-[2rem] bg-white/20 border border-white/50 overflow-hidden group hover:border-accent-blue/70 hover:bg-white/30 transition-colors duration-700 shadow-xl shadow-black/10 flex flex-col justify-center backdrop-blur-md w-full h-full">
