...
const Placement = () => {
    return (
        <section className="py-16 md:py-20 bg-white theme-light-section">
            <div className="w-full max-w-[1600px] mx-auto px-4 md:px-12 lg:px-16">
                <div className="text-center max-w-4xl mx-auto mb-16">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-3xl md:text-5xl font-heading font-bold mb-6 text-slate-900"
                    >
                ...
                <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
                    <div className="bg-slate-50 border border-slate-200 p-8 rounded-2xl hover:border-accent-cyan/40 transition-all shadow-md hover:shadow-xl">
                    ...
                    <div className="bg-slate-50 border border-slate-200 p-8 rounded-2xl hover:border-accent-blue/40 transition-all shadow-md hover:shadow-xl">
